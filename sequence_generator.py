...
OUTPUT_DIR = r"C:\Users\kotsgeo\Documents\GANs\Old\campr4"  # Using forward slashes is safer
...
def generate_and_filter_sequences(generator, num_samples=100000, device="cuda", count_atg=True, add_atg=False):
        ...
        for i in range(0, num_samples, batch_size):
            ...
            for seq in decoded_seqs:
                ...
                if ((clean_seq.endswith('TAA') or
                    ...
                    len(clean_seq) > 17):  # Ensure length is more than 17 bases = more that 5 amino acids
